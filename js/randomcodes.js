...
function disableButton(btnvalue){
    document.getElementById("sumbit").disabled= btnvalue; //able/disable button
    if (btnvalue == true) { //test if button disabled or enabled
        //set button and label color translucent
        document.getElementById("sumbit").style.backgroundColor = "rgba(73,119,209,0.3)";
        document.getElementById("sumbit").style.color = "rgba(255,255,255,0.5)";
    } else {
        //set button and label color with no transparency
        document.getElementById("submit").style.backgroundColor = "rgba(73,119,209,1)";
        document.getElementById("sumbit").style.color = "rgba(255,255,255,1)";
    }
}
